...
1. 处理中
```
URL:https://newem.800best.com/ajax/em/servicer/sendMsg
METHOD:POST
HEARD:Content-Type: application/x-www-form-urlencoded; charset=UTF-8

CONTENT:
id=16413978&
showColor=11&
showColorServicer=0&
content=%E5%B0%BD%E5%BF%AB%E9%80%80%E5%9B%9E%EF%BC%8C%E8%B0%A2%E8%B0%A2%EF%BC%81&
pictures=!!&
files=
```
2. 更新工单状态
```
POST https://newem.800best.com/ajax/em/updateStatus HTTP/1.1
Content-Type: application/x-www-form-urlencoded; charset=UTF-8

id=16414991&status=processing

{"success":true,"error":null,"messages":null,"vo":true,"voList":[],"data":[],"udf1":null,"strData":null}
```
#### 响应数据
1. 处理中
``` 
...
|key|value|
|:---|:---|
|v-model|drawersendMsg|
|direction|direction|
|工单状态：|tablelocation|
|发送数量：|tableDatanum|
|发送信息内容：v-model|inputsendMsg|
|发送信息按钮btnsenMsg|opendrawersendMsg|
|取消发送按钮|sendMsgcancelClick|
|确认发送按钮|sendMsgconfirmClick|
* 发送内容输入框
* 标签页位置
* 发送数量
* 发送信息属性及事件
...
7.  超时效工单，客户创建工单时间 - 百世仓库发货时间 大于60天

## 一些问题

>   页面出现两个滚动条的问题

![两个滚动条](https://raw.githubusercontent.com/liooes/images/main/markdown20230317020607.png) **这是由于子容器高度大于父容器则会显示滚动条** **解决方案**
...
[1] Cornel,Horstmann 著．Core Java 第 3 版．Prentice-Hall，2007:47-57.

[2] Bruce Eckel 著．Java 编程思想．北京:机械工业出版社，2014.01:12-22.

[3] Ivor Horton 著．Java2 入门经典．北京:机械工业出版社，2012.01:33-43.

[4] 饶锋,毛迪林,代春阳.JAVA2 安全机制与实例研究[J].计算机应用与软件, 2012 (11):35-37.

[5] 宛延周.JAVA 编程技巧[M].北京:机械工业出版社,2012:68-189:23-33.

[6] 施铮.Java 2 实用编程百例[M].北京:清华大学出版社,2005:43-89.

[7] （美）沃尔瑟（Walther，S.） 著，谭振林等译. ASP.NET2.0 揭秘[J],卷号(1). 人 民邮电出版社,2007.10:35-45.
